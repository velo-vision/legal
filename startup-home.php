      ...
      <div class="col l12 m12 s12 nomargin valign">
        <div class="col l12 m12 s12">
          ...
          <div class="col l8 m12 s12 hide-on-med-only hide-on-small-only">
            ...
            <div class="boton3 hvr-pulse">
              <a href="paquete-1.php"><img class="hvr-rotate" src="images/recursos/boton-startup-full.png" alt="Legla Nest"></a>
            </div>
            <div class="boton4">
        ...
        <div class="col l12 m10 offset-m1 s12">
          <div class="col l5 offset-l1 texto-rombos top-50">
            <p>
              Estás a punto de dar un paso muy importante para tu futuro, déjanos acompañarte en el proceso. LegalNest busca ser tu aliado
              durante todo el camino, <strong>la consultoría legal en esta etapa es crítica e indispensable.</strong>
            </p>
          </div>
